...
Repositorio: `github.com/mauricio-lenz/P1L3_Grupo4` — commit/tag de entrega: _(se agrega al final en el commit de entrega)_
...
`python -m src.run_all`. Commit/tag de entrega en el informe final del repo.